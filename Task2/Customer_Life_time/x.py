...
# Input fields
col1.title("Customer Prediction App")
col2.header("Input Parameters")

# Gender
CD_GENDER = col2.selectbox("CD_GENDER", ["Male", "Female"])
...
# Marital Status
CD_MARITAL_STATUS = col2.selectbox("CD_MARITAL_STATUS", ["D", "M", "S", "U", "W"])

# Credit Rating
CD_CREDIT_RATING = col2.selectbox("CD_CREDIT_RATING", ["Good", "High Risk", "Low Risk"])

# Education Status
CD_EDUCATION_STATUS = col2.selectbox("CD_EDUCATION_STATUS", ["2 yr Degree", "4 yr Degree", "Advanced Degree", "College", "Primary", "Secondary", "Unknown"])
